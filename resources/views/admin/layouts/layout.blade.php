...
<div class="wrapper">
              ...
              <li class="user-header">
                ...
                <p>
                 {{ Auth::user()->name }}- Web Developer
                  <small>Member depuis : {{ getSetting()->created_at}}</small>
                </p>
              </li>
              <!-- Menu Body -->
 ...
 @yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>{{getSetting()->site_name}} &copy; {{ date('Y')}} <a href="https://adminlte.io">Mokhfi Louanes</a>.</strong> Tout les droit sont résérve.
  </footer>
